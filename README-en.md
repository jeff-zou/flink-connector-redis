...
<br/>
 The project depends on Lettuce(6.2.1) and netty-transport-native-epoll(4.1.82.Final),flink-connection-redis-1.4.1.jar if these packages are available.
Otherwise, use flink-connector-redis-1.4.1-jar-with-dependencies.jar.
<br/>
