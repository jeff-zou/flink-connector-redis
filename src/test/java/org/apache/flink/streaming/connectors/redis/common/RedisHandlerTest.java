...
public class RedisHandlerTest extends AbstractTestBase {
    ...
    public static void setUp() {
        ...
        config.set(RedisOptions.CLUSTERNODES,"localhost:8080");
        config.set(RedisOptions.COMMAND, RedisCommand.SETEX.name());
    }
    ...
    public void testRedisMapper() {
        ...
        SetExMapper expectedMapper = new SetExMapper(1000, null);
