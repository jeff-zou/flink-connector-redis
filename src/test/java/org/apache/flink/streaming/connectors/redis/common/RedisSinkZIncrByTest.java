...
public class RedisSinkZIncrByTest extends RedisITCaseBase {
    ...
    public void redisSinkTest() throws Exception {
        ...
        RedisSink<Tuple2<String, Integer>> redisSink = new RedisSink<>(jedisClusterConfig, new RedisTestMapper(), null);
    ...
    private static class RedisTestMapper implements RedisMapper<Tuple2<String, Integer>> {
        ...
        public RedisCommandDescription getCommandDescription() {
            return new RedisCommandDescription(RedisCommand.ZINCRBY, ZINCRBY_NAME_PREFIX, null);
        }

        @Override
        public String getKeyFromData(Tuple2<String, Integer> data, List<Integer> keyIndexs) {
            return data.f0;
        }

        @Override
        public String getValueFromData(Tuple2<String, Integer> data, List<Integer> valueIndexs ) {
        ...
        @Override
        public String getPartitionFromData(Tuple2<String, Integer> data, Integer partitionColumnIndexs) {
            return null;
        }
    }
}
