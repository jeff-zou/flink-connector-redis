...
public interface RedisMapper<T> extends Function, Serializable {
     ...
     * @return key
     */
    String getKeyFromData(T data, List<Integer> keyIndexs);
     ...
     * @return value
     */
    String getValueFromData(T data, List<Integer> valueIndexs);

    /**
     *
     * @param data
     * @param partitionColumnIndexs
     * @return
     */
    String getPartitionFromData(T data, Integer partitionColumnIndexs);
