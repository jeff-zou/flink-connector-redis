 ...
 * you need to use first constructor {@link #RedisCommandDescription(RedisCommand, String, String)}.
 * If the {@code additionalKey} is {@code null} it will throw {@code IllegalArgumentException}
 *
 * If command is {@link RedisCommand#SETEX}, its required to use TTL. The proper constructor is {@link #RedisCommandDescription(RedisCommand, Integer, String)}.
 *
...
public class RedisCommandDescription implements Serializable {
     ...
     */
    public RedisCommandDescription(RedisCommand redisCommand, String additionalKey, Integer additionalTTL, String partitionColumn) {
     ...
     */
    public RedisCommandDescription(RedisCommand redisCommand, String additionalKey, String partitionColumn) {
        this(redisCommand, additionalKey, null, partitionColumn);
    }
     ...
     */
    public RedisCommandDescription(RedisCommand redisCommand, Integer additionalTTL, String partitionColumn) {
        this(redisCommand, null, additionalTTL, partitionColumn);
    }
    ...
    public RedisCommandDescription(RedisCommand redisCommand) {
        this(redisCommand, null, null, null);
    }
