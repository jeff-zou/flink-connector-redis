...
# 2 使用方法: 
## 2.1 工程直接引用
项目依赖Lettuce(6.2.1)及netty-transport-native-epoll(4.1.82.Final),如flink环境有这两个包,则使用flink-connector-redis-1.4.4.jar，
否则使用flink-connector-redis-1.4.4-jar-with-dependencies.jar。
<br/>
```
<dependency>
